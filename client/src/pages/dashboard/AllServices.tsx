...
const AllService = (props: Props): React.JSX.Element => {
  ...
  return (
    <>
      ...
      <div className="grid Pdesktop:grid-cols-3 gap-x-5 gap-y-10 Plaptop:grid-cols-3 Ptablet:grid-cols-2 Pmobile:grid-cols-1 Psmallmobile:grid-cols-1 w-full mt-5 mx-2 pl-3 ml-2 ">
        {services &&
          services.map((service: StateProps, index: number) => {
            return (
              <div
                className="min-w-[300px] w-[95%] min-h-[250px] shadow-sm shadow-gray-300 "
